...
export const createStore = ({ initialData = {} } = {}) => {
  return Hover.compose({
    ...
    creatives: Hover(creativesStore.actions, initialData.creatives || creativesStore.initialState),
    news: Hover(newsStore.actions, initialData.news || newsStore.initialState),
    stories: Hover(storyStore.actions, initialData.stories || storyStore.initialState)
  })
}
